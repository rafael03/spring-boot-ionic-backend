...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat4 = new Categoria(null, "Papelara");
		Categoria cat5 = new Categoria(null, "Ferramentas");
		Categoria cat6 = new Categoria(null, "Automotiva");
		...
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apt 300", "Jardim", "38220834", cli1, c1);
