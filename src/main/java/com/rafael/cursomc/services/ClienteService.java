...
import com.rafael.cursomc.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possivel exlcuir porquê há entidades relacionadas");
		}
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		...
		Endereco end = new Endereco(null, objDto.getLograduro(), objDto.getNumero(), objDto.getComplemento(),
